...
const EmptyState = ({ onActionClick }: { onActionClick: () => void }) => (
  <div className="text-center rounded-lg border-2 border-dashed border-gray-300 dark:border-gray-700 p-12">
    ...
    <h3 className="mt-2 text-lg font-semibold text-gray-800 dark:text-white">{t('groups.empty.title')}</h3>
    <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">{t('groups.empty.description')}</p>
    <div className="mt-6">
      <button
