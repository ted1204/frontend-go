...
export default function ProjectDetail() {
  ...
  // Data fetching logic remains the same, but we can fetch in parallel
  useEffect(() => {
  ...
  // All handler functions (handleCreate, handleUpdate, etc.) remain the same
  ...
  return (
    <div>
      ...
      {/* Main two-column layout for larger screens */}
      <div className="mt-8 grid grid-cols-1 gap-8 lg:grid-cols-3">
        ...
        <div className="flex flex-col gap-8 lg:col-span-2">
            ...
            <div className="flex items-center justify-between border-b border-gray-200 bg-gray-50/50 p-4 dark:border-gray-700 dark:bg-gray-800/50">
              ...
              <button className="rounded-lg p-2 text-gray-500 transition-colors hover:bg-gray-200 hover:text-gray-800 dark:hover:bg-gray-700 dark:hover:text-white">
                ...
                >
                  <path
                    fillRule="evenodd"
                    d="M11.49 3.17c-.38-1.56-2.6-1.56-2.98 0a1.532 1.532 0 01-2.286.948c-1.372-.836-2.942.734-2.106 2.106.54.982.54 2.295 0 3.277-1.139 2.067 2.022 4.11 4.11 2.973a1.532 1.532 0 013.277 0c2.088 1.137 5.249-.906 4.11-2.973a1.532 1.532 0 010-3.277c.836-1.372-.734-2.942-2.106-2.106a1.532 1.532 0 01-2.286-.948zM10 13a3 3 0 100-6 3 3 0 000 6z"
                    clipRule="evenodd"
                  />
                </svg>
              </button>
          ...
          {/* Config Files Section - REFINED & PROFESSIONAL VERSION */}
          {/* Config Files Section - FINAL & CORRECTED VERSION */}
            ...
            <div className="flex items-center justify-between border-b border-gray-200 p-4 sm:p-6 dark:border-gray-600">
              ...
              <Button
                ...
                className="
                  ...
                  shadow-sm                                      // 細微陰影
                  transition-all duration-150                    // 平滑過渡動畫
                  hover:bg-gray-50                               // 淺色模式下的懸停效果
                  dark:border-gray-600 dark:bg-gray-700          // 深色模式下的邊框和背景
                  dark:text-gray-200                             // ✅ 深色模式下的文字顏色 (淺灰色，清晰可見)
                  dark:hover:bg-gray-600                         // 深色模式下的懸停效果
                  focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 // 聚焦狀態 (通用)
                  disabled:cursor-not-allowed disabled:opacity-50  // 禁用狀態 (通用)
        ...
        <div className="lg:col-span-1">
          <div className="sticky top-24 rounded-2xl border border-gray-200 bg-white p-6 shadow-lg dark:border-gray-700/50 dark:bg-gray-800/60 dark:shadow-blue-500/10 backdrop-blur-lg">
